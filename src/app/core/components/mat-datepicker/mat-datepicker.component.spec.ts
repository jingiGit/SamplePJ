...
describe('MatDatepickerComponent', () => {
  ...
  describe('#ngOnInit', () => {
    describe('initialValue input', () => {
      it('should set initial value', () => {
        ...
        component.ngOnInit();
        expect(formatDate(component.date.value, 'yyyy/MM/dd', 'ja-JP')).toEqual(
          expectedDate
        );
      });
    ...
    describe('required input', () => {
      it('should set required validator', () => {
        ...
        component.ngOnInit();
        expect(component.date.setValidators).toHaveBeenCalledWith([
          Validators.required,
        ]);
      });
  ...
  describe('#addEvent', () => {
    it('should raise the event', () => {
      ...
      const htmlInputElemtnt = fixture.debugElement.query(
        By.css('input')
      ).nativeElement;
