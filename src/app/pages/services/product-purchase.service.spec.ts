...
describe('ProductPurchaseService', () => {
  const expectedHistorySearchResponseDto: ProductPurchaseHistorySearchResponseDto =
    createHistorySearchResponseDto();
  ...
  describe('#getProductPurchaseHistoryList', () => {
    ...
    it('should return expected response', () => {
      service
        .getProductPurchaseHistoryList(new HttpParams())
        .subscribe((response) => {
...
function createHistorySearchListResponseDto(
  ...
  const expectedProductPurchaseHistorySearchListResponseDto: ProductPurchaseHistorySearchListResponseDto =
    {
      productPurchaseHistorySearchResponseDtos: Array(
        expectedProductPurchaseHistorySearchResponseDto
      ),
      pageIndex: 0,
      resultsLength: 1,
    };
