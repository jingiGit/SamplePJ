...
describe('ProductRegisteringPageComponent_new', () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: TitleI18Service, useValue: titleI18ServiceSpy },
        {
          provide: Router,
          useValue: {
            url: UrlConst.SLASH + UrlConst.PATH_PRODUCT_REGISTERING + SLASH_NEW,
            navigate(): void {},
          },
        },
        {
  ...
  describe('#clickProductImageButton', () => {
    ...
    it('should return when not images', () => {
      ...
      const imageFile: File = createFile(
        VALUE_NOT_PRODUCT_IMAGE_BASE64,
        'test01.zip',
        'application/zip'
      );
    ...
    it('should load image', () => {
      // Setups image file.
      const imageFile: File = createFile(
        VALUE_PRODUCT_IMAGE_BASE64,
        'test01.img',
        'image/png'
      );
      const imageFileList: FileList = createFileList(Array(imageFile));

      spyOn<any>(component, privateMethodReadFile).and.returnValue(
        of(VALUE_PRODUCT_IMAGE_DATA_URL)
      );
      component.clickProductImageButton(imageFileList);

      expect(imageFileList.length).toEqual(1);
      expect(component[privateMethodReadFile]).toHaveBeenCalledWith(
        imageFileList[0]
      );
      expect(component.productImage.value).toEqual(
        VALUE_PRODUCT_IMAGE_DATA_URL
      );
    });
  });
  describe('#readFile', () => {
  ...
  describe('#clickSaveButton', () => {
    ...
    it('should create data', async () => {
      ...
      expect(productServiceSpy.updateProduct.calls.count()).toEqual(0);
      expect(component[privateMethodExtractResponse]).toHaveBeenCalledOnceWith(
        expectedProductDto
      );
      ...
      expect(component.productGenre.value).toEqual(
        expectedProductDto.productGenre
      );
      expect(component.productSizeStandard.value).toEqual(
        expectedProductDto.productSizeStandard
      );
      expect(component.productColor.value).toEqual(
        expectedProductDto.productColor
      );
      expect(component.productUnitPrice.value).toEqual(
      ...
      expect(component.endOfSaleDate.value).toEqual(
        expectedProductDto.endOfSaleDate
      );
      expect(component.productImage.value).toEqual(
  ...
  describe('DOM placeholder', () => {
    ...
    it('product genre', () => {
      const htmlElement: HTMLElement = fixture.debugElement.query(
        By.css(IDS.PRODUCT_GENRE_LABEL)
      ).nativeElement;
    ...
    it('product end of sale date', () => {
      ...
      fixture.whenStable().then(() => {
        const htmlElementEndOfSaleDate: HTMLInputElement =
  ...
  describe('DOM input test', () => {
    ...
    it('end of sale', () => {
      // Clicks checkbox's label
      HtmlElementUtility.clickHtmlElement<typeof component>(
        fixture,
        IDS.END_OF_SALE_LABEL
      );
  ...
  describe('DOM input validation test', () => {
    ...
    it('should enter the correct value in the product code', () => {
      ...
      const validationError: HTMLElement = fixture.debugElement.query(
  ...
  describe('DOM input/output test', () => {
    it('Should create product dto correctly', () => {
      ...
      component.receivedEventFromChild(
        expectedProductDto.endOfSaleDate.toString()
      );
      fixture.detectChanges();
      ...
      expect(productRequestDto.productName).toEqual(
        expectedProductDto.productName
      );
      expect(productRequestDto.productGenre).toEqual(VALUE_PRODUCT_GENRE);
      expect(productRequestDto.productSizeStandard).toEqual(
        expectedProductDto.productSizeStandard
      );
      expect(productRequestDto.productColor).toEqual(
        expectedProductDto.productColor
      );
      expect(productRequestDto.endOfSale).toBeTruthy();
      expect(productRequestDto.endOfSaleDate.toString()).toEqual(
        expectedProductDto.endOfSaleDate.toString()
      );
    ...
    it('Should set correctly on the screen', () => {
      ...
      ).toEqual(expectedProductDto.productCode);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_NAME)).nativeElement.value
      ).toEqual(expectedProductDto.productName);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_GENRE)).nativeElement
          .innerText
      ).toContain(VALUE_PRODUCT_GENRE_NAME);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_SIZE_STANDARD))
          .nativeElement.value
      ).toEqual(expectedProductDto.productSizeStandard);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_COLOR)).nativeElement
          .value
      ).toEqual(expectedProductDto.productColor);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_UNIT_PRICE)).nativeElement
          .value
      ).toEqual(VALUE_PRODUCT_UNIT_PRICE_FORMATED);
      expect(
        fixture.debugElement.query(By.css(IDS.END_OF_SALE_INPUT)).nativeElement
          .value
      ).toBeTruthy();
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_IMAGE)).nativeElement.src
      ).toEqual(expectedProductDto.productImage);
    });
  });
});
