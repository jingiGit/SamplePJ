...
const VALUE_PRODUCT_PURCHASE_DATE_FROM_RECEIVED =
  'Wed Jan 01 2020 00:00:00 GMT+0900';
const VALUE_PRODUCT_PURCHASE_DATE_TO_RECEIVED =
  'Tue Jan 01 2030 00:00:00 GMT+0900';
...
describe('PurchaseHistoryListingPageComponent', () => {
  ...
  describe('#clickClearButton', () => {
    it('should clear', () => {
      ...
      component.productPurchaseDateFrom.setValue(
        VALUE_PRODUCT_PURCHASE_DATE_FROM
      );
  ...
  describe('#clickSearchButton', () => {
    describe('If the page index does not change after searching', () => {
      it('should search normally', () => {
        ...
        expect(
          productPurchaseServiceSpy.getProductPurchaseHistoryList.calls.count()
        ).toEqual(1);
  ...
  describe('#receivedEventFromChildFrom', () => {
    it('should set date', () => {
      component.receivedEventFromChildFrom(
        VALUE_PRODUCT_PURCHASE_DATE_FROM_RECEIVED
      );
      expect(component.productPurchaseDateFrom.value).toEqual(
        VALUE_PRODUCT_PURCHASE_DATE_FROM_RECEIVED
      );
  ...
  describe('#receivedEventFromChildTo', () => {
    it('should set date', () => {
      component.receivedEventFromChildTo(
        VALUE_PRODUCT_PURCHASE_DATE_TO_RECEIVED
      );
      expect(component.productPurchaseDateTo.value).toEqual(
        VALUE_PRODUCT_PURCHASE_DATE_TO_RECEIVED
      );
  ...
  describe('#createSearchParamsDto', () => {
    it('Should create product listing search params dto correctly', () => {
      ...
      const searchParamsDto: PurchaseHistoryListingSearchParamsDto =
...
function createExpectedSearchListResponseDto(): ProductPurchaseHistorySearchListResponseDto {
  ...
  const productPurchaseHistorySearchListResponseDto: ProductPurchaseHistorySearchListResponseDto =
    {
      productPurchaseHistorySearchResponseDtos:
        productPurchaseHistorySearchResponseDto,
      pageIndex: VALUE_PAGE_INDEX,
      resultsLength: 1,
    };
