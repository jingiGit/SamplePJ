  ...
  implements OnInit, AfterViewChecked
{
  ...
  public matDatePickerComponents: QueryList<MatDatepickerComponent>;
    ...
    merge(this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.productPurchaseService.getProductPurchaseHistoryList(
            this.createHttpParams(searchParamsDto)
          );
        }),
        map((data) => {
  ...
  private createSearchParamsDto(): PurchaseHistoryListingSearchParamsDto {
    ...
    if (this.productPurchaseDateTo.value) {
      ...
      productPurchaseDateToISOString = new Date(
  ...
  private createHttpParams(
    purchaseHistoryListingSearchParamsDto: PurchaseHistoryListingSearchParamsDto
  ): HttpParams {
    const paramsOptions = {
      fromObject: purchaseHistoryListingSearchParamsDto,
    } as any;
  ...
  private clearSearchConditions(): void {
    ...
    this.matDatePickerComponents.map((matDatePickerComponent) =>
      matDatePickerComponent.reset()
    );
