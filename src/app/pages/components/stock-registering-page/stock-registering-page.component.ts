...
export class StockRegisteringPageComponent implements OnInit, AfterViewChecked {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result) {
        const productStockRequestDto: ProductStockRequestDto =
          this.createProductStockRequestDto();
  ...
  private getProductStock(): void {
    ...
    this.productStockService
      .getProductStock(this.productCode.value)
      .subscribe((data) => {
  ...
  private updateProductStock(
    ...
    this.productStockService
      .updateProductStock(productStockRequestDto)
      .subscribe((data) => {
  ...
  private extractGetProductStockResponseDto(
    ...
    this.productGenre.setValue(
      this.translateService.instant(
        'genre.' + productStockResponseDto.productGenre
      )
    );
    this.productSizeStandard.setValue(
      productStockResponseDto.productSizeStandard
    );
    this.productStockQuantity.setValue(
  ...
  private extractUpdateProductStockResponseDto(
    productStockResponseDto: ProductStockResponseDto
  ): void {
    if (!productStockResponseDto) {
      return;
