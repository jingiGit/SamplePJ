...
describe('PurchaseQuantityStockQuantityValidator', () => {
  ...
  describe('#validate', () => {
    const parameters = [
      ...
      {
        description:
          'should not have error | productPurchaseQuantity is not numeric',
      ...
      {
        description:
          'should not have error | productStockQuantity is not numeric',
        productPurchaseQuantity: 1,
      ...
      {
        description:
          'should not have error | productPurchaseQuantity less than productStockQuantity',
        productPurchaseQuantity: 1,
      ...
      {
        description:
          'should not have error | productPurchaseQuantity equals productStockQuantity',
        productPurchaseQuantity: 1,
        productStockQuantity: 1,
        expectedErrorOfProductPurchaseQuantity: null,
      },
      {
        description:
          'should have error | productPurchaseQuantity exceeds productStockQuantity',
    ...
    parameters.forEach((parameter) => {
      it(parameter.description, () => {
        ...
        expect(
          testingForm
            .get(PRODUCT_PURCHASE_QUANTITY)
            .getError('exceedStockError')
        ).toEqual(parameter.expectedErrorOfProductPurchaseQuantity);
      });
    });
  });
});
