...
describe('DummyPurchasingPageComponent', () => {
  ...
  let productPurchaseServiceSpy: {
    getProductPurchase: jasmine.Spy;
    createProductPurchase: jasmine.Spy;
  };
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: AccountService, useValue: accountServiceSpy },
        {
          ...
          useValue: productPurchaseServiceSpy,
        },
  ...
  describe('#blurProductCode', () => {
    it('no product code', async () => {
      ...
      expect(
        productPurchaseServiceSpy.getProductPurchase.calls.count()
      ).toEqual(0);
    });
    ...
    it('should load data', async () => {
      component.productCode.setValue(VALUE_PRODUCT_CODE_LOWER);
      productPurchaseServiceSpy.getProductPurchase.and.returnValue(
        of(expectedProductPurchaseResponseDto)
      );
      component.blurProductCode();
      expect(productPurchaseServiceSpy.getProductPurchase.calls.count()).toBe(
        1
      );
      expect(component.productName.value).toEqual(
      ...
      expect(component.productSizeStandard.value).toEqual(
        expectedProductPurchaseResponseDto.productSizeStandard
      );
      expect(component.productPurchaseUnitPrice.value).toEqual(
      ...
      expect(component.productImage.value).toEqual(
  ...
  describe('#clickSaveButton', () => {
    it('should not create data', () => {
      ...
      productPurchaseServiceSpy.createProductPurchase.and.returnValue(
        of(expectedProductPurchaseResponseDto)
      );
      component.clickSaveButton();
      expect(
        productPurchaseServiceSpy.createProductPurchase.calls.count()
      ).toEqual(0);
    });
  ...
  describe('#blurProductPurchaseQuantity', () => {
    it('should not set purchase amount when productPurchaseQuantity is blank', () => {
      component.productPurchaseUnitPrice.setValue(
        VALUE_PRODUCT_PURCHASE_UNIT_PRICE
      );
  ...
  describe('DOM placeholder', () => {
    it('title', () => {
      const htmlElement: HTMLElement = fixture.debugElement.query(
        By.css(IDS.TITLE)
      ).nativeElement;
  ...
  describe('DOM input validation test', () => {
    ...
    it('product purchase name', () => {
      ...
      const validationError = fixture.debugElement.query(
        By.css(CLASSES.VALIDATION_ERROR)
      ).nativeElement;
    ...
    it('PurchaseQuantityStockQuantityValidator', () => {
      ...
      const exceedingMaximumValue = String(
        expectedProductPurchaseResponseDto.productStockQuantity + 1
      );
      HtmlElementUtility.setValueToHTMLInputElement<typeof component>(
        fixture,
        IDS.PRODUCT_PURCHASE_QUANTITY,
  ...
  describe('DOM output test', () => {
    it('Should Enter product code and get product purchase data then display screen', () => {
      ...
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_CODE)).nativeElement.value
      ).toEqual(expectedProductPurchaseResponseDto.productCode);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_NAME)).nativeElement.value
      ).toEqual(expectedProductPurchaseResponseDto.productName);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_GENRE)).nativeElement
          .value
      ).toEqual(VALUE_PRODUCT_GENRE_NAME);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_SIZE_STANDARD))
          .nativeElement.value
      ).toEqual(expectedProductPurchaseResponseDto.productSizeStandard);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_UNIT_PRICE)).nativeElement
          .value
      ).toEqual(VALUE_PRODUCT_PURCHASE_UNIT_PRICE_FORMATED);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_STOCK_QUANTITY))
          .nativeElement.value
      ).toEqual(VALUE_PRODUCT_STOCK_QUANTITY_FORMATED);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_IMAGE)).nativeElement.src
      ).toEqual(expectedProductPurchaseResponseDto.productImage);
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_PURCHASE_NAME))
          .nativeElement.value
      ).toEqual('');
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_PURCHASE_QUANTITY))
          .nativeElement.value
      ).toEqual('');
      expect(
        fixture.debugElement.query(By.css(IDS.PRODUCT_PURCHASE_AMOUNT))
          .nativeElement.value
      ).toEqual('');
    });
    ...
    it('Should Enter input and create purchase request', () => {
      ...
      const productPurchaseRequestDto: ProductPurchaseRequestDto =
        component[privateMethodName]();
      expect(productPurchaseRequestDto.productCode).toEqual(
        VALUE_PRODUCT_CODE_UPPER
      );
      expect(productPurchaseRequestDto.productPurchaseName).toEqual(
        VALUE_PRODUCT_PURCHASE_NAME
      );
      expect(productPurchaseRequestDto.productStockQuantity).toEqual(
        VALUE_PRODUCT_STOCK_QUANTITY
      );
      expect(productPurchaseRequestDto.productPurchaseQuantity).toEqual(
        VALUE_PRODUCT_PURCHASE_QUANTITY
      );
    });
  });
